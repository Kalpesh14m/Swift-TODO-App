//Purpose:
    ...
    //2.Used for showing notes in archive.
    //3.Used for showing notes in reminder.
    //4.Used for showing notes in delete.
    //5.Used for set color for each cell.
    //6.Used for delete single or multipal cells.
    //7.Used for Moving cell (Swap) from one location to another Location.
...
//MARK: IBOutlet
    ...
    @IBOutlet weak var ArchiveUndoView: UIView!
...
//MARK:Variable Declaration
    ...
    @IBAction func removeView(_ sender: UIButton)
    {
        ...
        if let selection = mCollectionView.indexPathsForSelectedItems
        {
            ...
            {
                selection.sorted{ $1.compare($0) == .orderedAscending}
        ...
        else
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    mCollectionView.backgroundColor = .blue
                    shadowM()
                }
            }
        }
