...
//Purpose:
    //1.Used for Add New Note.
    //2.It shows Current Time on bottom
    //3.It has Buttons like:
        //3.1.Reminder
        //3.2.Color
        //3.3.IsImp
        //3.4.Options
...
//        NotificationCenter.default.addObserver(self, selector: #selector(loadReminderData), name: NSNotification.Name(rawValue: "load"), object: nil)
    ...
    override func viewWillAppear(_ animated: Bool)
    {
        ...
        //Right Button
        self.navigationItem.setRightBarButtonItems([reminderbarButton,optionbarButton,pinbarButton,ColorbarButton], animated: true)
        navigationController?.navigationBar.isHidden = false
